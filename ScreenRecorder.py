...
class ScreenRecorder:
    """
          Класс для записи игры в PyGame и сохранения её в файл
          Код взят с github ссылка на источник https://github.com/tdrmk/pygame_recorder?ysclid=lv840d9amf246304330
    """
